...
export default function TermsOfService() {
  return (
    <main className="page-wrap" style={{ maxWidth: "800px", margin: "40px auto", padding: "40px 20px", color: "var(--cream-60)", lineHeight: 1.6 }}>
      ...
      <p style={{ marginBottom: "16px" }}>Welcome to RoastMyResume (Macoostudy). By using our website and services, you agree to comply with the following terms:</p>
      ...
      <p style={{ marginBottom: "16px" }}> RoastMyResume provides AI-powered feedback and suggestions for career preparation. While we aim to optimize screening chances, we do not guarantee employment, interviews, or hiring placement.</p>
